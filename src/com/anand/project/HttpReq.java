...
public class HttpReq extends AsyncTask<String, Void , String> {
	...
	protected String doInBackground(String... params) {
		...
		HttpGet httpGet = new HttpGet("https://maps.googleapis.com/maps/api/directions/json?origin="+MainActivity.lat+","+MainActivity.lng+"&destination="+MainActivity.destination+"&mode=driving&key=AIzaSyBLQHBnivZ-Kd6nVCYliCyMssZYhJtQAzc");
		try{
